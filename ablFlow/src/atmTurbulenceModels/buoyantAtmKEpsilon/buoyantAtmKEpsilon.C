...
buoyantAtmKEpsilon<BasicTurbulenceModel>::buoyantAtmKEpsilon
(
...
template<class BasicTurbulenceModel>
bool buoyantAtmKEpsilon<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
buoyantAtmKEpsilon<BasicTurbulenceModel>::Gcoef() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix>
buoyantAtmKEpsilon<BasicTurbulenceModel>::kSource() const
{
    const uniformDimensionedVectorField& g =
        this->mesh_.objectRegistry::template
        lookupObject<uniformDimensionedVectorField>("g");
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix>
buoyantAtmKEpsilon<BasicTurbulenceModel>::epsilonSource() const
{
    const uniformDimensionedVectorField& g =
        this->mesh_.objectRegistry::template
        lookupObject<uniformDimensionedVectorField>("g");
