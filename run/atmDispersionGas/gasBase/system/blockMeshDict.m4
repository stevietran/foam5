...
define(d,30)dnl>
define(h,d)dnl>
define(cellSize,calc(d/3))dnl>
define(AR,20)dnl>
define(cellRatio,1.1)dnl>
dnl>
define(x0,calc(d*(-5.)))dnl>
define(x3,calc(d*30.))dnl>
dnl>
define(y0,0.0)dnl>
define(y2,calc(d*10.))dnl>
dnl>
define(z0,0.0)dnl>
define(z1,calc(d*1.))dnl>
dnl>
define(nAxial,calc(int((int(x3)-int(x0))/cellSize)))dnl>
define(AxialGrade,1)dnl>
dnl>
define(nRad,calc(int((int(y2)-int(y0))/cellSize)))dnl>
